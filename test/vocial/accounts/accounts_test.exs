defmodule Vocial.AccountsTest do
    ...
    describe "users" do
        ...
        test "create_user/1 fails to create the user without a password 
        and password_confirmation" do
        ...
        test "get_user_by_username/1 returns the user with the matching
        username" do
            user = user_fixture()
